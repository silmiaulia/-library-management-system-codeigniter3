...
<body> 
        ...
        <div class="main-content">
            ...
            <div class="container mx-3 my-4">
                ...
                <table class="table table-striped mt-4">
                    ...
                    <tr>
                        ...
                        <th scope="col"><strong>Tanggal Dikembalikan</strong></th>
                    </tr>
                    </thead>
                    <tbody>
                    <?php
                    ...
                    <tr>
                        ...
                        <td><br><strong><?php echo $row->tanggal_kembali;?></strong></td>
                    </tr>
                    <?php endforeach;?>
                    </tbody>
                </table>
            <?php 
                    ...
                    echo "<h3 class='mx-3 px-4'>Tidak ada history peminjaman</h3>";
                }
            ?>
            </div><br>
