...
<body> 
        ...
        <div class="main-content">
            ...
            <section>
                <h2 class="mb-3"><center>Update Bibliografi</center></h2>
                <form action="<?php echo base_url('index.php/admin_bibliografi/update');?>" method="post" class="form" enctype="multipart/form-data">
                    <input type="hidden" id="custId" name="id_bibliografi" value="<?php echo $biblio->id_bibliografi;?>">
                    <div class="mb-3">
                        ...
                        <input type="text" name="call_number" id="call_number" class="form-control col-md-10"
                            placeholder="Masukkan call number" value="<?php echo $biblio->call_number;?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="isbn" class="form-label">ISBN</label>
                        <input type="text" name="isbn" id="isbn" class="form-control col-md-10"
                            placeholder="Masukkan ISBN" value="<?php echo $biblio->isbn;?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="judul" class="form-label">Judul</label>
                        <input type="text" name="judul" id="judul" class="form-control col-md-10"
                        placeholder="Masukkan judul buku" value="<?php echo $biblio->judul;?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="edisi" class="form-label">Edisi</label>
                        <input type="text" name="edisi" id="edisi" class="form-control col-md-10"
                                placeholder="Masukkan edisi buku" value="<?php echo $biblio->edisi;?>">
                    </div>
                    <div class="mb-3">
                        <label for="penerbit" class="form-label">Penerbit</label>
                        <input type="text" name="penerbit" id="penerbit" class="form-control col-md-10"
                            placeholder="Masukkan penerbit" value="<?php echo $biblio->penerbit;?>">
                    </div>
                    <div class="mb-3">
                        <label for="penulis" class="form-label">Penulis</label>
                        <input type="text" name="penulis" id="penulis" class="form-control col-md-10"
                            placeholder="Masukkan penulis" value="<?php echo $biblio->penulis;?>">
                    </div>
                    <div class="mb-3">
                        <label for="tahun" class="form-label">Tahun</label>
                        <input type="text" name="tahun" id="tahun" class="form-control col-md-10"
                            placeholder="Masukkan tahun terbit" value="<?php echo $biblio->tahun;?>">
                    </div>
                    <div class="mb-3">
                        <label for="kategori" class="form-label">Kategori</label>
                        <input type="text" name="kategori" id="kategori" class="form-control col-md-10"
                            placeholder="Masukkan kategori" value="<?php echo $biblio->kategori;?>">
                    </div>
                    <div class="mb-3">
                        <label for="harga" class="form-label">Harga</label>
                        <input type="text" name="harga" id="harga" class="form-control col-md-10"
                            placeholder="Masukkan harga" value="<?php echo $biblio->harga;?>">
                    </div>
                    <div class="mb-3">
