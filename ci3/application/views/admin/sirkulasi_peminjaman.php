...
<body> 
        ...
        <div class="main-content">
            ...
            <!-- input pencarian koleksi -->
            <div class="container mx-3 my-0">
                <form name="userinput" action="<?php echo base_url('index.php/sirkulasi/cariKoleksi')?>" method="post">
                    <div class="mb-3 w-25">
                        <input type="text" name="kode_koleksi" class="form-control" id="exampleFormControlInput1" placeholder="Cari kode koleksi...">
            ...
            <div class="container mx-3 my-4">
                ...
                <table class="table table-striped mt-4">
                    ...
                    <tr>
                        <td><br><?php echo $koleksi->kode_koleksi;?></td>
                        <td><br><?php echo $biblioDetail_CallNumber->judul;?></td>
                        <td align='center'>
                            <form name="userinput" action="<?php echo base_url('index.php/sirkulasi/addTransaksi')?>" method="post">
                                <div class="mb-3 w-25">
                                    <button type="submit" class="btn btn-primary my-4">Pinjam</button>
                                    <input type="hidden" id="custId" name="id_anggota" value="<?php echo $anggota->id_anggota;?>">
                                    <input type="hidden" id="custId" name="kode_koleksi" value="<?php echo $koleksi->kode_koleksi;?>">
            ...
            <?php 
                    ...
                    echo "<h3 class='mx-3 px-4'>Koleksi yang dicari tidak ada</h3>";
                }
            }?>
            </div><br>
