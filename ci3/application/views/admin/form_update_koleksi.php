...
<body> 
        ...
        <div class="main-content">
            ...
            <section>
                <h2 class="mb-3"><center>Update Koleksi</center></h2>
                <form action="<?php echo base_url('index.php/koleksi/update');?>" method="post" class="form" enctype="multipart/form-data">
                    <input type="hidden" id="id_koleksi" name="id_koleksi" value="<?php echo $koleksi->id_koleksi;?>">
                    <input type="hidden" id="call_number" name="call_number" value="<?php echo $koleksi->call_number;?>">
                    <div class="mb-3">
                        ...
                        <input type="text" name="kode_koleksi" id="kode_koleksi" class="form-control col-md-10" 
                            placeholder="Masukkan kode koleksi" value="<?php echo $koleksi->kode_koleksi;?>">
                    </div>
                    <div class="mb-3">
