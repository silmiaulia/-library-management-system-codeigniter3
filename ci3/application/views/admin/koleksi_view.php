...
<body> 
        ...
        <div class="main-content">
            <div class="container mx-5 my-4">
                <h3><strong><center>DAFTAR KOLEKSI</center></strong></h3>

                <a class='btn btn-success' href="<?php echo base_url('index.php/koleksi/form/'.$call_number);?>" role='button'>Tambah</a>
                ...
                ?>
                    ...
                    $count = 0;
                        ...
                        foreach ($koleksi as $row) :
                            // site_url('koleksi/bibliografi/'.$row->call_number);
                            $count++;
                    ?>
                        <tr>
                            <th scope="row"><?php echo $count;?></th>
                            <td width="30%"><img src = "<?php echo base_url('assets/images/'.$row->foto)?>" class="w-25"></td>
                            <td><?php echo $row->judul;?></td>
                            <td><?php echo $row->kode_koleksi;?></td>
                            <td><?php echo $row->nomor_register;?></td>
                            <td align='center'>
                                <a class='btn btn-primary' href="<?php echo base_url('index.php/koleksi/formUpdate/'.$row->id_koleksi)?>" role='button'>Update</a>
                                <a class='btn btn-danger' href="<?php echo base_url('index.php/koleksi/delete/'.$row->id_koleksi)?>" role='button'>Delete</a>
                            </td>
                        </tr>
                    <?php 
                        endforeach;
                        ...
                        echo "<h3 class='mx-0 my-5'>Tidak terdapat koleksi</h3>";
                    }
