...
<body> 
        ...
        <div class="main-content">
            ...
            <section>
                <h2 class="mb-3"><center>Update Anggota</center></h2>
                <form action="<?php echo base_url('index.php/anggota/update');?>" method="post" class="form" enctype="multipart/form-data">
                    <input type="hidden" id="id_anggota" name="id_anggota" value="<?php echo $anggota->id_anggota;?>">
                    <div class="mb-3">
                        <label for="nama_anggota" class="form-label">Nama Anggota</label>
                        <input type="text" name="nama_anggota" id="nama_anggota" class="form-control col-md-10"
                            placeholder="Masukkan nama anggota" value="<?php echo $anggota->nama_anggota;?>" >
                    </div>
                    <div class="mb-3">
                        <div><label for="jenis_kelamin" class="form-label">Jenis Kelamin</label></div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="jenis_kelamin" name="jenis_kelamin" value="Laki-laki" <?php echo (isset($anggota->jenis_kelamin) && $anggota->jenis_kelamin === 'Laki-laki')? 'checked' : '';?>>
                            <label class="form-check-label" for="laki-laki">Laki-laki</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" id="jenis_kelamin" name="jenis_kelamin" value="Perempuan" <?php echo (isset($anggota->jenis_kelamin) && $anggota->jenis_kelamin === 'Perempuan')? 'checked' : '';?>>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="no_telepon" id="no_telepon" class="form-control col-md-10"
                                placeholder="Masukkan no telepon " value="<?php echo $anggota->no_telepon;?>" >
                    </div>
                    <div class="mb-3">
                        <label for="email" class="form-label">Email</label>
                        <input type="text" name="email" id="email" class="form-control col-md-10"
                                placeholder="Masukkan email " value="<?php echo $anggota->email;?>" >
                    </div>
                    <br>
                    <div class="mb-3">
